                ...
                <div className="offcanvas__content">
                    ...
                    <div className="offcanvas__contact">
                        ...
                        <div className="offcanvas__contact-content d-flex">
                            ...
                            <a href="https://www.google.com/maps/search/86+Road+Broklyn+Street,+600+New+York,+USA/@40.6897806,-74.0278086,12z/data=!3m1!4b1">36/A1,E Square,Edappally,Kochi PO- 682024</a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                            ...
                            <div className="offcanvas__contact-content-content">
                            <a href="mailto:needhelp@company.com">help@webeyecraft.com  </a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                            ...
                            <div className="offcanvas__contact-content-content">
                            <a href="tel:01310-069824"> +91 79943 94866</a>
                            </div>
                        </div>
                    </div>

                    ...
                    <div className="col-lg-12">
                        <div className="row align-items-center">
                            ...
                            <div className="tp-blog-title-wrapper">
                                ...
                                <h3 className="tp-section-title">Recent Blog in <span className="title-color">Webeyecraft</span>
                            ...
                            <div className="tp-blog-text justify-content-start justify-content-lg-end d-flex">
                                <p>Stay updated with the latest trends in digital marketing and web development. Discover expert tips, industry insights, and innovative strategies to elevate your online presence.
                                </p>
                            </div>
                            </div>
                        </div>

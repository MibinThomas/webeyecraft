...
const about_data = [
    {
        ...
        description: <>We specialize in boosting your online presence with <br /> tailored digital marketing strategies
        <br /> and cutting-edge web development solutions.</>,
    },
    {
        id:2,
        img: about_img_2,
        title: "Digital Education & Training Services",
        description: <>Empower your team with our expert-led digital education and training programs<br /> designed to enhance skills
        <br /> and drive success in the digital landscape</>
    },
    {
        id:2,
        img: about_img_3,
        title: "Artificial intelligence",
        description: <>AI enhances digital marketing by automating tasks, analyzing data, <br /> 
                     ...
                     <div className="tp-about-wrapper pl-50">
                           ...
                           <div className="col-lg-8">
                              <div className="tp-about-title-wrapper p-relative">
                                 <span className="tp-section-title__pre">
                                    Best <span className="title-pre-color">Digital Solutions</span>
                                    <AngleArrow /> 
                                 </span>
                                 <h3 className="tp-section-title">Industries that We’re Offering
                        ...
                        <div className="tp-about-item-wrapper"> 
                           ...
                           <div className="tp-about-call">
                              <a href="tel:917994394866">
                                 <p><i className="fa-solid fa-phone"></i> 
                                 Provide Digital services to many customers <span>+91 79943 94866</span></p>
                              </a>
                           </div>

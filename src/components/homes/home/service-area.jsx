                        ...
                        <div className="col-lg-12">
                           <div className="tp-service-title-wrapper text-center">
                              <span className="tp-section-title__pre">
                                 service <span className="title-pre-color">Digital Solutions</span> 
                                 <AngleArrow />                                 
                              </span>
                              <h3 className="tp-section-title">All Professional <i>Digital Solutions</i> & Services
                        ...
                        <div className="col-lg-6 col-md-12">
                           <div className="tp-fun-fact-content">
                              <div className="tp-fun-fact-title-wrapper">
                                 ...
                                 <h3 className="tp-section-title">Elevate your brand
                                    <span className="title-left-shape"> 
                                    <LineArrowTwo />
                                    </span>
                                 </h3>
                                 <p>
                                 Welcome to webeyecraft, where innovation meets strategy.
                                 We are a dynamic digital marketing agency dedicated to transforming your online presence. 
                                 Our team of experts leverages cutting-edge technology and creative solutions to drive growth and success for your business. 
                                 Join us on a journey to elevate your brand and <br /> connect with your audience like never before
                                 </p>
                                 <ul>
                                    <li>
                                       <span> <GreenRightArrow /></span>
                                       Targeted Advertising: Leverage data analytics to create highly targeted ad campaigns that reach the right audience at the right time, maximizing ROI and engagement
                                    </li>
                                    <li>
                                       <span><GreenRightArrow /> </span>
                                       Performance Optimization: Focus on optimizing website speed and performance, including fast loading times and efficient coding practices, to enhance user satisfaction and search engine rankings
                                    </li>
                                 </ul>
                                 <div className="tp-fun-fact-btn">
                                    <Link className="tp-btn" href="/contact">Let's Connect</Link>
                                 </div>
                              </div>
                           </div>
                        </div>

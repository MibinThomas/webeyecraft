...
import Logo from "@assets/img/logo/logo100-100 .svg";
                     ...
                     <div className="row align-items-center">
                        <div className="col-xxl-6 col-xl-8">
                           <div className="tp-header-top-info">
                              <ul>
                                 <li>
                                    <a href="https://maps.app.goo.gl/jbmmVtrp2EXAdtwg7" 
                                    target="_blank"><span>
                                       <i className="fa-sharp fa-solid fa-location-dot"></i>
                                       </span>36/A1,E Square,Edappally,Kochi PO- 682024</a>
                                 </li>
                                 <li>
                                    <a href="mailto:technix@support.com"><span>
                                       <i className="fa-solid fa-envelope"></i></span>info@webeyecraft.com
                                    </a>
                                 </li>
                                 <li>
                        ...
                        <div className="col-xxl-6 col-xl-4">
                           <div className="tp-header-top-right d-flex justify-content-end align-items-center">
                              <div className="header-call">
                                 <a href="tel:917994394866"><i className="fa-solid fa-phone"></i>+91 7994394866</a>
                              </div>
                              <div className="header-social d-xxl-block d-none">
                                 <Link href="https://www.instagram.com/webeyecraft_technologies/?hl=en"><i className="fa-brands fa-facebook"></i> Facebook</Link>
                                 <Link href="https://x.com/Webeyecraftec"><i className="fa-brands fa-twitter"></i> Twitter</Link>
                                 <Link href="https://www.linkedin.com/in/webeyecraft-technologies-392655324/"><i className="fa-brands fa-linkedin"></i> Linkedin</Link>
                              </div>
                           </div>
                        </div>
                     </div>

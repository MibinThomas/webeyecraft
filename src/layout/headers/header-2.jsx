                     ...
                     <div className="row align-items-center">
                        <div className="col-xl-6">
                           <div className="tp-header-2-top-info">
                              <p><i className="fa-solid fa-clock"></i> Open Hours of City Govt. (Mon - Fri: <span>9.00</span> am - <span>5.00</span> pm)</p>
                           </div>
                        </div>
                        <div className="col-xl-6">
                           <div className="tp-header-2-top-right d-flex justify-content-end align-items-center">
                              ...
                              <div className="header-location">
                                 <Link target='_blank' href="https://www.google.com/maps/place/Taco+Bell/@33.9694034,-112.7228178,17z/data=!3m1!4b1!4m6!3m5!1s0x80d34e9ca49e9761:0x8b141f1593605d2a!8m2!3d33.9694034!4d-112.7206291!16s%2Fg%2F1tdwkssz"><i className="fa-sharp fa-solid fa-location-dot"></i>36/A1 E-SquarEdapally Junction Edapally ,Enakulam,PIN Code - 682024,Phone: +91 7994394866,Email: webeyecraft@gmail.com</Link>
                              </div>
